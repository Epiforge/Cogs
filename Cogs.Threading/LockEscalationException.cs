...
public class LockEscalationException : Exception
{
    ...
    /// </summary>
    public LockEscalationException() :
        base("cannot escalate lock")
    {
    }
    ...
    public LockEscalationException(string message) :
        base(message)
    {
    }
    ...
    public LockEscalationException(string message, Exception innerException) :
