...
public static class Extensions
{
    ...
    static Expression SubstituteMethodsImplementation(Expression expression, (MethodInfo replace, MethodInfo substitution)[] substitutions) =>
        expression switch
        {
            ...
            NewArrayExpression newArrayExpression when newArrayExpression.NodeType == ExpressionType.NewArrayBounds =>
            ...
            TypeBinaryExpression typeBinaryExpression when typeBinaryExpression.NodeType == ExpressionType.TypeIs =>
                Expression.TypeIs
                (
