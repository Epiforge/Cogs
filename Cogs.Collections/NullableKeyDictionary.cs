...
namespace Cogs.Collections
{
    ...
    public class NullableKeyDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        /// </summary>
        public NullableKeyDictionary() => dict = new Dictionary<TKey, TValue>();
        ...
        public NullableKeyDictionary(IEqualityComparer<TKey> comparer) => dict = new Dictionary<TKey, TValue>(comparer);
        ...
        public NullableKeyDictionary(int capacity) => dict = new Dictionary<TKey, TValue>(capacity);
        ...
        /// <param name="capacity">The initial number of elements that the <see cref="ObservableDictionary{TKey, TValue}"/> can contain</param>
        /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing keys, or <c>null</c> to use the default <see cref="EqualityComparer{T}"/> for the type of the key</param>
        public NullableKeyDictionary(int capacity, IEqualityComparer<TKey> comparer) => dict = new Dictionary<TKey, TValue>(capacity, comparer);
        ...
        bool ICollection<KeyValuePair<TKey, TValue>>.IsReadOnly => ((IDictionary<TKey, TValue>)dict).IsReadOnly;

        /// <summary>
        /// Gets an <see cref="ICollection{T}"/> containing the keys of the <see cref="IDictionary{TKey, TValue}"/>
        /// </summary>
        public ICollection<TKey> Keys => (hasNullKeyedValue ? new TKey[] { default! } : Enumerable.Empty<TKey>()).Concat(((IDictionary<TKey, TValue>)dict).Keys).ToImmutableArray();
        ...
        /// </summary>
        public ICollection<TValue> Values => (hasNullKeyedValue ? new TValue[] { nullKeyedValue } : Enumerable.Empty<TValue>()).Concat(((IDictionary<TKey, TValue>)dict).Values).ToImmutableArray();
        ...
        {
            if (item.Key is null)
                return hasNullKeyedValue && EqualityComparer<TValue>.Default.Equals(nullKeyedValue, item.Value);
