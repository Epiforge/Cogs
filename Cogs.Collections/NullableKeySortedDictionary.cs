...
namespace Cogs.Collections
{
    ...
    public class NullableKeySortedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, ISortKeys<TKey>
    {
        ...
        /// </summary>
        public NullableKeySortedDictionary() => dict = new SortedDictionary<TKey, TValue>();
        ...
        public NullableKeySortedDictionary(IComparer<TKey> comparer) => dict = new SortedDictionary<TKey, TValue>(comparer);
