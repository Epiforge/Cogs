    ...
    ISynchronizedObservableRangeDictionary<TKey, TValue>
{
    ...
    public SynchronizedObservableDictionary(IDictionary<TKey, TValue> dictionary) :
    ...
    public SynchronizedObservableDictionary(IEqualityComparer<TKey> comparer) :
    ...
    public SynchronizedObservableDictionary(int capacity) :
        this(SynchronizationContext.Current ?? Synchronization.DefaultSynchronizationContext, capacity)
    {
    }
    ...
    /// <param name="dictionary">The <see cref="IDictionary{TKey, TValue}"/> whose elements are copied to the new <see cref="SynchronizedObservableDictionary{TKey, TValue}"/></param>
    /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing keys, or <c>null</c> to use the default <see cref="EqualityComparer{T}"/> for the type of the key</param>
    public SynchronizedObservableDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
    ...
    /// <param name="capacity">The initial number of elements that the <see cref="SynchronizedObservableDictionary{TKey, TValue}"/> can contain</param>
    /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing keys, or <c>null</c> to use the default <see cref="EqualityComparer{T}"/> for the type of the key</param>
    public SynchronizedObservableDictionary(int capacity, IEqualityComparer<TKey> comparer) :
        this(SynchronizationContext.Current ?? Synchronization.DefaultSynchronizationContext, capacity, comparer)
    {
    }
    ...
    public SynchronizedObservableDictionary(SynchronizationContext? synchronizationContext) :
        base() => SynchronizationContext = synchronizationContext;
    ...
    /// <param name="synchronizationContext">The <see cref="System.Threading.SynchronizationContext"/> on which to perform all operations</param>
    /// <param name="dictionary">The <see cref="IDictionary{TKey, TValue}"/> whose elements are copied to the new <see cref="SynchronizedObservableDictionary{TKey, TValue}"/></param>
    public SynchronizedObservableDictionary(SynchronizationContext? synchronizationContext, IDictionary<TKey, TValue> dictionary) :
        base(dictionary) =>
    ...
    /// <param name="synchronizationContext">The <see cref="System.Threading.SynchronizationContext"/> on which to perform all operations</param>
    /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing keys, or <c>null</c> to use the default <see cref="EqualityComparer{T}"/> for the type of the key</param>
    public SynchronizedObservableDictionary(SynchronizationContext? synchronizationContext, IEqualityComparer<TKey> comparer) :
        base(comparer) =>
        SynchronizationContext = synchronizationContext;
    ...
    /// <param name="synchronizationContext">The <see cref="System.Threading.SynchronizationContext"/> on which to perform all operations</param>
    /// <param name="capacity">The initial number of elements that the <see cref="SynchronizedObservableDictionary{TKey, TValue}"/> can contain</param>
    public SynchronizedObservableDictionary(SynchronizationContext? synchronizationContext, int capacity) :
        base(capacity) =>
        SynchronizationContext = synchronizationContext;
    ...
    /// <param name="dictionary">The <see cref="IDictionary{TKey, TValue}"/> whose elements are copied to the new <see cref="SynchronizedObservableDictionary{TKey, TValue}"/></param>
    /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing keys, or <c>null</c> to use the default <see cref="EqualityComparer{T}"/> for the type of the key</param>
    public SynchronizedObservableDictionary(SynchronizationContext? synchronizationContext, IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
    ...
    /// <param name="capacity">The initial number of elements that the <see cref="SynchronizedObservableDictionary{TKey, TValue}"/> can contain</param>
    /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing keys, or <c>null</c> to use the default <see cref="EqualityComparer{T}"/> for the type of the key</param>
    public SynchronizedObservableDictionary(SynchronizationContext? synchronizationContext, int capacity, IEqualityComparer<TKey> comparer) :
    ...
    protected override void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex) =>
        this.Execute(() => base.CopyTo(array, arrayIndex));
    ...
    public override int EnsureCapacity(int capacity) =>
        this.Execute(() => base.EnsureCapacity(capacity));
    ...
    public override void TrimExcess(int capacity) =>
        this.Execute(() => base.TrimExcess(capacity));
    ...
    public override bool TryAdd(TKey key, TValue value) =>
        this.Execute(() => base.TryAdd(key, value));
    ...
    protected override (bool valueRemoved, TValue value) TryRemove(TKey key) =>
        this.Execute(() => base.TryRemove(key));
