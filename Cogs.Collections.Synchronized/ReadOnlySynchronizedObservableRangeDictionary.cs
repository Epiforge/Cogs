    ...
    ISynchronizedObservableRangeDictionary<TKey, TValue>
{
    ...
    public ReadOnlySynchronizedObservableRangeDictionary(ISynchronizedObservableRangeDictionary<TKey, TValue> synchronizedObservableRangeDictionary) :
        base(synchronizedObservableRangeDictionary) =>
        this.synchronizedObservableRangeDictionary = synchronizedObservableRangeDictionary;
    ...
    public Task<int> CountAsync =>
        synchronizedObservableRangeDictionary.CountAsync;

    /// <summary>
    /// Gets the <see cref="System.Threading.SynchronizationContext"/> on which this object's operations occur
    /// </summary>
    public SynchronizationContext? SynchronizationContext =>
        synchronizedObservableRangeDictionary.SynchronizationContext;

    Task ISynchronizedObservableRangeDictionary<TKey, TValue>.AddAsync(TKey key, TValue value) =>
        Task.FromException(new NotSupportedException());

    Task ISynchronizedObservableRangeDictionary<TKey, TValue>.AddRangeAsync(IEnumerable<KeyValuePair<TKey, TValue>> keyValuePairs) =>
        Task.FromException(new NotSupportedException());

    Task ISynchronizedObservableRangeDictionary<TKey, TValue>.AddRangeAsync(IReadOnlyList<KeyValuePair<TKey, TValue>> keyValuePairs) =>
        Task.FromException(new NotSupportedException());

    Task ISynchronizedObservableRangeDictionary<TKey, TValue>.ClearAsync() =>
        Task.FromException(new NotSupportedException());
    ...
    public Task<bool> ContainsKeyAsync(TKey key) =>
        synchronizedObservableRangeDictionary.ContainsKeyAsync(key);
    ...
    public Task<bool> ContainsValueAsync(TValue value) =>
        synchronizedObservableRangeDictionary.ContainsValueAsync(value);
    ...
    public IReadOnlyList<TKey> GetAllKeys() =>
        synchronizedObservableRangeDictionary.GetAllKeys();

    /// <summary>
    /// Copies all keys in the read-only synchronized observable range dictionary into a <see cref="IReadOnlyList{T}"/>
    /// </summary>
    public Task<IReadOnlyList<TKey>> GetAllKeysAsync() =>
        synchronizedObservableRangeDictionary.GetAllKeysAsync();
    ...
    public Task<IReadOnlyList<KeyValuePair<TKey, TValue>>> GetRangeAsync(IEnumerable<TKey> keys) =>
        synchronizedObservableRangeDictionary.GetRangeAsync(keys);
    ...
    public Task<TValue> GetValueAsync(TKey key) =>
        synchronizedObservableRangeDictionary.GetValueAsync(key);

    Task<IReadOnlyList<KeyValuePair<TKey, TValue>>> ISynchronizedObservableRangeDictionary<TKey, TValue>.RemoveAllAsync(Func<TKey, TValue, bool> predicate) =>
        Task.FromException<IReadOnlyList<KeyValuePair<TKey, TValue>>>(new NotSupportedException());

    Task<bool> ISynchronizedObservableRangeDictionary<TKey, TValue>.RemoveAsync(TKey key) =>
        Task.FromException<bool>(new NotSupportedException());

    Task<IReadOnlyList<TKey>> ISynchronizedObservableRangeDictionary<TKey, TValue>.RemoveRangeAsync(IEnumerable<TKey> keys) =>
        Task.FromException<IReadOnlyList<TKey>>(new NotSupportedException());

    Task ISynchronizedObservableRangeDictionary<TKey, TValue>.ReplaceRangeAsync(IEnumerable<KeyValuePair<TKey, TValue>> keyValuePairs) =>
        Task.FromException(new NotSupportedException());

    Task<IReadOnlyList<TKey>> ISynchronizedObservableRangeDictionary<TKey, TValue>.ReplaceRangeAsync(IEnumerable<TKey> removeKeys, IEnumerable<KeyValuePair<TKey, TValue>> newKeyValuePairs) =>
        Task.FromException<IReadOnlyList<TKey>>(new NotSupportedException());

    Task ISynchronizedObservableRangeDictionary<TKey, TValue>.ResetAsync() =>
        Task.FromException(new NotSupportedException());

    Task ISynchronizedObservableRangeDictionary<TKey, TValue>.ResetAsync(IDictionary<TKey, TValue> dictionary) =>
        Task.FromException(new NotSupportedException());

    Task ISynchronizedObservableRangeDictionary<TKey, TValue>.SetValueAsync(TKey key, TValue value) =>
        Task.FromException(new NotSupportedException());
    ...
    public Task<(bool valueRetrieved, TValue value)> TryGetValueAsync(TKey key) =>
        synchronizedObservableRangeDictionary.TryGetValueAsync(key);
}
