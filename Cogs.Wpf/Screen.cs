...
namespace Cogs.Wpf
{
    ...
    public class Screen : IEquatable<Screen>
    {
        ...
        private Screen(System.Windows.Forms.Screen formsScreen) => this.formsScreen = formsScreen;
        ...
        public override bool Equals(object? obj) => Equals(obj as Screen);
        ...
        public bool Equals(Screen? other) => other is not null && formsScreen == other.formsScreen;
        ...
        /// </summary>
        public static IReadOnlyList<Screen> AllScreens => System.Windows.Forms.Screen.AllScreens.Select(s => new Screen(s)).ToImmutableArray();
        ...
        public static Screen FromHandle(IntPtr hwnd) => new Screen(System.Windows.Forms.Screen.FromHandle(hwnd));
        ...
        public static Screen FromPoint(Point point) => new Screen(System.Windows.Forms.Screen.FromPoint(GetDeviceDependentPoint(point)));
        ...
        public static Screen FromRect(Rect rect) => new Screen(System.Windows.Forms.Screen.FromRectangle(GetDeviceDependentRectangle(rect)));
        ...
        /// </returns>
        public static Rect GetBounds(Point point) => GetDeviceIndependentRect(System.Windows.Forms.Screen.GetBounds(GetDeviceDependentPoint(point)));
        ...
        /// </returns>
        public static Rect GetBounds(Rect rect) => GetDeviceIndependentRect(System.Windows.Forms.Screen.GetBounds(GetDeviceDependentRectangle(rect)));
        ...
        /// (in multiple display environments where no display contains the specified point, the display closest to the point is returned)
        /// </returns>
        public static Rect GetWorkingArea(Point point) => GetDeviceIndependentRect(System.Windows.Forms.Screen.GetWorkingArea(GetDeviceDependentPoint(point)));
        ...
        /// </returns>
        public static Rect GetWorkingArea(Rect rect) => GetDeviceIndependentRect(System.Windows.Forms.Screen.GetWorkingArea(GetDeviceDependentRectangle(rect)));
