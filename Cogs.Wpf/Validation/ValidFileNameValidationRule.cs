...
namespace Cogs.Wpf.Validation
{
    ...
    /// </summary>
    public class ValidFileNameValidationRule : InvalidCharactersValidationRule
    {
        /// <summary>
        /// Creates a new instance of the <see cref="ValidFileNameValidationRule"/> class
        /// </summary>
        public ValidFileNameValidationRule() : base() => InvalidCharacters = Path.GetInvalidFileNameChars();
