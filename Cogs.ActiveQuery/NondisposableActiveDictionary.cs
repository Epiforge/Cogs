...
public class NondisposableActiveDictionary<TKey, TValue> : INondisposableActiveDictionary<TKey, TValue>
{
    /// <summary>
    ...
    /// </summary>
    public IComparer<TKey>? Comparer => activeDictionary.GetKeyComparer();
    ...
    /// </summary>
    public IEqualityComparer<TKey>? EqualityComparer => activeDictionary.GetKeyEqualityComparer();

    /// <summary>
    /// Gets the <see cref="ActiveQuery.IndexingStrategy"/> in use by the <see cref="NondisposableActiveDictionary{TKey, TValue}"/>
    /// </summary>
    public IndexingStrategy? IndexingStrategy => activeDictionary.GetIndexingStrategy();

    /// <summary>
    /// Gets whether this object has been disposed
    /// </summary>
    public bool IsDisposed => activeDictionary.IsDisposed;

    /// <summary>
    /// Gets an enumerable collection that contains the keys in the read-only dictionary
    /// </summary>
    public IEnumerable<TKey> Keys => activeDictionary.Keys;

    /// <summary>
    /// Gets the exception that occured the most recent time the query updated
    /// </summary>
    public Exception? OperationFault => activeDictionary.OperationFault;

    /// <summary>
    /// Gets the <see cref="System.Threading.SynchronizationContext"/> on which this object's operations occur
    /// </summary>
    public SynchronizationContext? SynchronizationContext => activeDictionary.SynchronizationContext;

    /// <summary>
    /// Gets an enumerable collection that contains the values in the read-only dictionary
    /// </summary>
    public IEnumerable<TValue> Values => activeDictionary.Values;
    ...
    public TValue this[TKey key] => activeDictionary[key];
    ...
    void ActiveDictionaryDictionaryChanged(object sender, NotifyDictionaryChangedEventArgs<object?, object?> e) => DictionaryChangedBoxed?.Invoke(this, e);

    void ActiveDictionaryDisposed(object sender, DisposalNotificationEventArgs e) => Disposed?.Invoke(this, e);

    void ActiveDictionaryDisposing(object sender, DisposalNotificationEventArgs e) => Disposing?.Invoke(this, e);

    void ActiveDictionaryElementFaultChanged(object sender, ElementFaultChangeEventArgs e) => ElementFaultChanged?.Invoke(this, e);

    void ActiveDictionaryElementFaultChanging(object sender, ElementFaultChangeEventArgs e) => ElementFaultChanging?.Invoke(this, e);

    void ActiveDictionaryGenericDictionaryChanged(object sender, NotifyDictionaryChangedEventArgs<TKey, TValue> e) => DictionaryChanged?.Invoke(this, e);

    void ActiveDictionaryPropertyChanged(object sender, PropertyChangedEventArgs e) => PropertyChanged?.Invoke(this, e);

    void ActiveDictionaryPropertyChanging(object sender, PropertyChangingEventArgs e) => PropertyChanging?.Invoke(this, e);

    /// <summary>
    /// Gets a list of all faulted elements
    /// </summary>
    /// <returns>The list</returns>
    public IReadOnlyList<(object? element, Exception? fault)> GetElementFaults() => activeDictionary.GetElementFaults();
    ...
    IEnumerator IEnumerable.GetEnumerator() => ((IEnumerable)activeDictionary).GetEnumerator();
